# How to contribute to line/gorocksdb

First of all, thank you so much for taking your time to contribute!
It will be amazing if you could help us by doing any of the following:

- File an issue in [the issue tracker](https://github.com/line/gorocksdb/issues) to report bugs and propose new features and
  improvements.
- Ask a question by creating a new issue in [the issue tracker](https://github.com/line/gorocksdb/issues).
  - Browse [the list of previously answered questions](https://github.com/line/gorocksdb/issues?q=label%3Aquestion).
- Contribute your work by sending [a pull request](https://github.com/line/gorocksdb/pulls).
...
We expect contributors to follow [our code of conduct](https://github.com/line/gorocksdb/blob/main/CODE_OF_CONDUCT.md).
...
While my fork lives at `https://github.com/someone/gorocksdb`,
the code should never exist at `$GOPATH/src/github.com/someone/gorocksdb`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/line/gorocksdb`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/line/gorocksdb`)
- `git remote rename origin upstream`
- `git remote add origin git@github.com:someone/gorocksdb.git`

Now `origin` refers to my fork and `upstream` refers to the gorocksdb version.
So I can `git push -u origin main` to update my fork, and make pull requests to gorocksdb from there.
...
Tests can be ran by running `make test` at the top level of the gorocksdb repository.
...
- create a development branch either on github.com/line/gorocksdb, or your fork (using `git remote add origin`)
